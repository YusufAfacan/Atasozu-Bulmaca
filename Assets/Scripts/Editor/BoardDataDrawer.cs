...
public class BoardDataDrawer : Editor
{
    ...
    {
        InitiliazeReorderableList(ref _dataList, "SearchWords", "Searching Words");
    }
    ...
    private void InitiliazeReorderableList(ref ReorderableList list, string propertyName, string listLabel)
    {
